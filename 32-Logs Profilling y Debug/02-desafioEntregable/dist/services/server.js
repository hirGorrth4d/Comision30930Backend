...
var StoreOptions = {
  store: _connectMongo["default"].create({
    mongoUrl: _index["default"].MONGO_ATLAS_URL
  }),
...
app.use('/api', _randomRouter["default"]); //MANEJO DE RUTAS INEXISTENTES

app.use(function (req, res) {
  res.status(404);

  _logger.logger.warn('RUTA: /rutas inexistentes || METODO: get');
});
var _default = app;
